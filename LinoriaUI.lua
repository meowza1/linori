...
function Linoria:CreateWindow(options)
    ...
    function tabData:AddColumn(columnCount)
    ...
    function tabData:AddElement(element, columnIndex)
    ...
    function tabData:UpdateCanvasSize()
        local totalHeight = 0
        for _, col in ipairs(self.Columns) do
            local colHeight = 0
    ...
    function tabData:AddToggle(options)
        options = options or {}
    ...
    function tabData:AddDropdown(options)
        options = options or {}
    ...
    function tabData:AddRadio(options)
        options = options or {}
    ...
    function tabData:AddColorpicker(options)
        options = options or {}
        ...
        local svOverlay = Utility:Create("ImageLabel", {
            ...
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
            Image = "rbxassetid://4155801252", -- Black gradient (inverted via ImageColor3)
    ...
    function tabData:AddTextbox(options)
        options = options or {}
    ...
    function tabData:AddLabel(options)
        options = options or {}
    ...
    function tabData:AddButton(options)
        options = options or {}
    ...
    function tabData:AddSlider(options)
        options = options or {}
    ...
    function tabData:AddSection(options)
        options = options or {}
